...
class FormHistory(Base):
    ...
    def __init__(self):
        ...
        self.attr_list.append(
            BaseAttribute(FIRST_USED, DT_MILLI_ZEROED_MICRO, self.first_used_timestamp)
        )
        self.attr_list.append(
            BaseAttribute(LAST_USED, DT_MILLI_ZEROED_MICRO, self.last_used_timestamp)
        )
